...
<div class="flex justify-between items-center">
    ...
    <div class="whitespace-nowruppercase font-bold text-[#C3C3D1] flex items-center space-x-2 px-[8px] py-[4px] rounded-full bg-[#181826] border border-[#1E1E2C] text-[12px]">
        <x-ui.icons.clock class="w-[18px] h-[18px]"/>
        <span>{{ str_pad($proposal->hours, 2, "2", STR_PAD_LEFT) }} horas</span>
    </div>
</div>
